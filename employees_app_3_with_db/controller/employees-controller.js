...
const getAllEmployees = async (req, res) => {
  ...
  const getAllEmployeesWithId = async (req, res) => {
  ...
  const getEmployeesCreate = async (req, res) => {
  ...
  const getEmployeesUpdate = async (req, res) => {
  ...
  const getEmployeesDeleted = async (req, res) => {
...
module.exports = {getAllEmployees , getAllEmployeesWithId, getEmployeesCreate, getEmployeesUpdate, getEmployeesDeleted }
